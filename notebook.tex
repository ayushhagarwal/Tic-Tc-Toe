...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{}This is the function we are defining to get the game board. We grab the indexp ositions and print them to get the board}
        \PY{k+kn}{from} \PY{n+nn}{IPython}\PY{n+nn}{.}\PY{n+nn}{display} \PY{k}{import} \PY{n}{clear\PYZus{}output}
        \PY{k}{def} \PY{n+nf}{game\PYZus{}board}\PY{p}{(}\PY{n}{board}\PY{p}{)}\PY{p}{:}
            \PY{n}{clear\PYZus{}output}\PY{p}{(}\PY{p}{)}  \PY{c+c1}{\PYZsh{}this doesnt allow to show the previous history on the board. This we the user will feel that the board is }
            \PY{c+c1}{\PYZsh{}being updated intead of a printing a new version of the board.}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Below is the game board which will be used in the game}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
            ...
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Designed by Ayush Agrawal}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{n}{test\PYZus{}board} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsh{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
        \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{test\PYZus{}board}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{def} \PY{n+nf}{player\PYZus{}input}\PY{p}{(}\PY{p}{)}\PY{p}{:}
            \PY{n}{mark}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZsq{}}  \PY{c+c1}{\PYZsh{}currently x or o is not defined for any player}
            \PY{k}{while} \PY{n}{mark}\PY{o}{!=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}} \PY{o+ow}{and} \PY{n}{mark}\PY{o}{!=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{mark}\PY{o}{=}\PY{n+nb}{input}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Player\PYZus{}one you are requested to chose a mark for your game to begin, chose X or O::}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
                
        \PY{c+c1}{\PYZsh{}while is used beacuse it will repeat the loop every time the input is not x or o and keep on asking for input suitable to game}
        
            \PY{n}{player\PYZus{}one}\PY{o}{=}\PY{n}{mark}
            \PY{k}{if} \PY{n}{player\PYZus{}one}\PY{o}{==}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                \PY{n}{player\PYZus{}two}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{O}\PY{l+s+s1}{\PYZsq{}}
            \PY{k}{else}\PY{p}{:}
                \PY{n}{player\PYZus{}two}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}
            \PY{k}{return}\PY{p}{(}\PY{n}{player\PYZus{}one}\PY{p}{,}\PY{n}{player\PYZus{}two}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{p}{(}\PY{n}{player\PYZus{}one\PYZus{}mark}\PY{p}{,}\PY{n}{player\PYZus{}two\PYZus{}mark}\PY{p}{)}\PY{o}{=}\PY{n}{player\PYZus{}input}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
Player\_one you are requested to chose a mark for your game to begin, chose X or O::X

    \end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{n}{player\PYZus{}one\PYZus{}mark}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}5}]:} 'X'
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{player\PYZus{}two\PYZus{}mark}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}6}]:} 'O'
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{}now we desgin a function so that a mark is taken and assigned to our game board}
        \PY{k}{def} \PY{n+nf}{place\PYZus{}mark}\PY{p}{(}\PY{n}{board}\PY{p}{,}\PY{n}{mark}\PY{p}{,}\PY{n}{position}\PY{p}{)}\PY{p}{:}
            \PY{n}{board}\PY{p}{[}\PY{n}{position}\PY{p}{]}\PY{o}{=}\PY{n}{mark}
            
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{place\PYZus{}mark}\PY{p}{(}\PY{n}{test\PYZus{}board}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZpc{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{)}   \PY{c+c1}{\PYZsh{}test that the mark assignment is working or not}
        \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{test\PYZus{}board}\PY{p}{)}
\end{Verbatim}
...
Designed by Ayush Agrawal
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k}{def} \PY{n+nf}{win\PYZus{}check}\PY{p}{(}\PY{n}{board}\PY{p}{,}\PY{n}{mark}\PY{p}{)}\PY{p}{:}           \PY{c+c1}{\PYZsh{}conditions for winning across rows columns and diagonals}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n}{win\PYZus{}check}\PY{p}{(}\PY{n}{test\PYZus{}board}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{X}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{c+c1}{\PYZsh{}we see it returns true because x is winner on the diagonals on our test board    }
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{}now the very basx fundamental of any game is to decide who goes first}
         \PY{c+c1}{\PYZsh{} this can be don eusing random.randit a python keyword which decides random value out of two and we can use if else}
         \PY{c+c1}{\PYZsh{}we can treat it like a coint toss}
         \PY{k+kn}{import} \PY{n+nn}{random}
         
         \PY{k}{def} \PY{n+nf}{coin\PYZus{}toss}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{coin\PYZus{}toss}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} 'Player 2'
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{c+c1}{\PYZsh{}now we define a function to check if position on the bopard is freely available or not}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{c+c1}{\PYZsh{}function to check if the board is full to return a boolean value }
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}function to ask players next position to put the marker}
         \PY{k}{def} \PY{n+nf}{player\PYZus{}choice}\PY{p}{(}\PY{n}{board}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{while} \PY{n}{position} \PY{o+ow}{not} \PY{o+ow}{in} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{,}\PY{l+m+mi}{8}\PY{p}{,}\PY{l+m+mi}{9}\PY{p}{]} \PY{o+ow}{or} \PY{o+ow}{not} \PY{n}{space\PYZus{}check}\PY{p}{(}\PY{n}{board}\PY{p}{,} \PY{n}{position}\PY{p}{)}\PY{p}{:}
                 \PY{n}{position} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{input}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Choose your next position: (1\PYZhy{}9) }\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{p}{)}       \PY{c+c1}{\PYZsh{}while because if not correct it asks again nd again}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{def} \PY{n+nf}{replay}\PY{p}{(}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{c+c1}{\PYZsh{}now all the functions are ready we just need to put them together using while loops and run the game}
\end{Verbatim}


    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Lets have some fun via this old game of tic\PYZhy{}tac\PYZhy{}toe}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        
        \PY{k}{while} \PY{k+kc}{True}\PY{p}{:}
            \PY{c+c1}{\PYZsh{} Reset the board}
            \PY{n}{newBoard} \PY{o}{=} \PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{ }\PY{l+s+s1}{\PYZsq{}}\PY{p}{]} \PY{o}{*} \PY{l+m+mi}{10}
            \PY{n}{player1\PYZus{}mark}\PY{p}{,} \PY{n}{player2\PYZus{}mark} \PY{o}{=} \PY{n}{player\PYZus{}input}\PY{p}{(}\PY{p}{)}
            \PY{n}{turn} \PY{o}{=} \PY{n}{coin\PYZus{}toss}\PY{p}{(}\PY{p}{)}
            ...
            \PY{k}{while} \PY{n}{game\PYZus{}on}\PY{p}{:}
                \PY{k}{if} \PY{n}{turn} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Player 1}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
                    ...
                    \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                    \PY{n}{position} \PY{o}{=} \PY{n}{player\PYZus{}choice}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                    \PY{n}{place\PYZus{}mark}\PY{p}{(}\PY{n}{newBoard}\PY{p}{,} \PY{n}{player1\PYZus{}mark}\PY{p}{,} \PY{n}{position}\PY{p}{)}
        
                    \PY{k}{if} \PY{n}{win\PYZus{}check}\PY{p}{(}\PY{n}{newBoard}\PY{p}{,} \PY{n}{player1\PYZus{}mark}\PY{p}{)}\PY{p}{:}
                        \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Congratulations! You have won the game!}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                        \PY{n}{game\PYZus{}on} \PY{o}{=} \PY{k+kc}{False}
                    \PY{k}{else}\PY{p}{:}
                        \PY{k}{if} \PY{n}{full\PYZus{}board\PYZus{}check}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}\PY{p}{:}
                            \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                ...
                \PY{k}{else}\PY{p}{:}
                    ...
                    \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                    \PY{n}{position} \PY{o}{=} \PY{n}{player\PYZus{}choice}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
                    \PY{n}{place\PYZus{}mark}\PY{p}{(}\PY{n}{newBoard}\PY{p}{,} \PY{n}{player2\PYZus{}mark}\PY{p}{,} \PY{n}{position}\PY{p}{)}
        
                    \PY{k}{if} \PY{n}{win\PYZus{}check}\PY{p}{(}\PY{n}{newBoard}\PY{p}{,} \PY{n}{player2\PYZus{}mark}\PY{p}{)}\PY{p}{:}
                        \PY{n}{game\PYZus{}board}\PY{p}{(}\PY{n}{newBoard}\PY{p}{)}
